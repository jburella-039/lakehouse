...
view: dim_marca {
  ...
  # OJO: la columna `Marca` trae un código (ej. "*7¿"); el nombre legible
  # (Elea, ROEMMERS, ...) está en `Descripcion`.
  ...
  # GAP: EsMarcaPropia está SIN POBLAR en trd_comercial.marca (0/4220 en true).
  # El "Marca Propia" del Power BI (8,10%) no es reproducible hasta que el ETL
  # popule este flag (o se cargue la lista de marcas propias). NO usar todavía.
