...
# periodo (filtro Fecha) y el % de comparacion es una measure de la vista (*_yoy),
# via single_value comparison_type: change (flecha verde sube / roja baja).
# Margen % en puntos porcentuales (pp). Escuchan fecha -> fct_remitos.filtro_fecha.
# =============================================================================
