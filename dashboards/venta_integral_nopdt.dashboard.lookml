...
- dashboard: venta_integral_nopdt
  title: "Venta Integral (sin PDT - test)"
  layout: newspaper
  ...
  - title: "Ventas"
    ...
    explore: fct_ventas_nopdt
    type: single_value
    fields: [fct_ventas_nopdt.venta_periodo, fct_ventas_nopdt.venta_yoy]
    filters:
      fct_ventas_nopdt.en_periodo_o_aa: "yes"
  ...
  - title: "Tickets"
    ...
    explore: fct_ventas_nopdt
    type: single_value
    fields: [fct_ventas_nopdt.tickets_periodo, fct_ventas_nopdt.tickets_yoy]
    filters:
      fct_ventas_nopdt.en_periodo_o_aa: "yes"
    show_single_value_title: true
  ...
  - title: "Unidades"
    ...
    explore: fct_ventas_nopdt
    type: single_value
    fields: [fct_ventas_nopdt.unidades_periodo, fct_ventas_nopdt.unidades_yoy]
    filters:
      fct_ventas_nopdt.en_periodo_o_aa: "yes"
    show_single_value_title: true
  ...
  - title: "Ventas por dia"
    ...
    type: looker_area
    colors: ["#2E7D32"]
    fields: [dim_fecha.fecha_date, fct_ventas_nopdt.venta_neta]
  ...
  - title: "Tickets por dia"
    ...
    type: looker_area
    colors: ["#F57C00"]
    fields: [dim_fecha.fecha_date, fct_ventas_nopdt.tickets]
    sorts: [dim_fecha.fecha_date]
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 3
    col: 8
  ...
  - title: "Unidades por dia"
    ...
    type: looker_area
    colors: ["#FBC02D"]
    fields: [dim_fecha.fecha_date, fct_ventas_nopdt.unidades]
    sorts: [dim_fecha.fecha_date]
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 3
    col: 16
  ...
  - title: "Ticket Promedio"
    ...
    explore: fct_ventas_nopdt
    type: single_value
    fields: [fct_ventas_nopdt.ticket_promedio_periodo, fct_ventas_nopdt.ticket_promedio_yoy]
    show_single_value_title: true
  ...
  - title: "Unidades por Ticket"
    ...
    explore: fct_ventas_nopdt
    type: single_value
    fields: [fct_ventas_nopdt.unidades_por_ticket_periodo, fct_ventas_nopdt.unidades_por_ticket_yoy]
    show_single_value_title: true
  ...
  - title: "Margen %"
    ...
    explore: fct_ventas_nopdt
    type: single_value
    fields: [fct_ventas_nopdt.margen_pct_periodo, fct_ventas_nopdt.margen_pct_yoy]
    show_single_value_title: true
  ...
  - title: "Margen $"
    ...
    explore: fct_ventas_nopdt
    type: single_value
    fields: [fct_ventas_nopdt.margen_periodo, fct_ventas_nopdt.margen_yoy]
    show_single_value_title: true
    single_value_title: "Margen $"
    show_comparison: true
    comparison_type: change
  ...
  - title: "Resumen por Formato (Periodo Seleccionado vs Periodo Anterior)"
    ...
    fields: [dim_formato.formato, fct_ventas_nopdt.venta_periodo, fct_ventas_nopdt.venta_yoy, fct_ventas_nopdt.tickets_periodo, fct_ventas_nopdt.tickets_yoy, fct_ventas_nopdt.unidades_periodo, fct_ventas_nopdt.unidades_yoy]
    filters:
      fct_ventas_nopdt.en_periodo_o_aa: "yes"
    sorts: [fct_ventas_nopdt.venta_periodo desc]
    hidden_fields: [fct_ventas_nopdt.venta_periodo, fct_ventas_nopdt.venta_yoy, fct_ventas_nopdt.tickets_periodo, fct_ventas_nopdt.tickets_yoy, fct_ventas_nopdt.unidades_periodo, fct_ventas_nopdt.unidades_yoy]
    dynamic_fields:
    - table_calculation: ventas_cur
      label: "Ventas"
      expression: "${fct_ventas_nopdt.venta_periodo}"
      value_format_name: usd_0
      _kind_hint: measure
      _type_hint: number
    - table_calculation: ventas_anio_ant
      label: "Ventas Año Ant"
      expression: "${fct_ventas_nopdt.venta_yoy}"
      value_format_name: percent_1
      _kind_hint: measure
      _type_hint: number
    - table_calculation: tickets_cur
      label: "Tickets"
      expression: "${fct_ventas_nopdt.tickets_periodo}"
      value_format_name: decimal_0
      _kind_hint: measure
      _type_hint: number
    - table_calculation: tickets_anio_ant
      label: "Tickets Año Ant"
      expression: "${fct_ventas_nopdt.tickets_yoy}"
      value_format_name: percent_1
      _kind_hint: measure
      _type_hint: number
    - table_calculation: unidades_cur
      label: "Unidades"
      expression: "${fct_ventas_nopdt.unidades_periodo}"
      value_format_name: decimal_0
      _kind_hint: measure
      _type_hint: number
    - table_calculation: unidades_anio_ant
      label: "Unidades Año Ant"
      expression: "${fct_ventas_nopdt.unidades_yoy}"
      value_format_name: percent_1
      _kind_hint: measure
      _type_hint: number
    listen: { fecha: fct_ventas_nopdt.filtro_fecha, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
  ...
  - title: "Resumen por Canal (Periodo Seleccionado vs Periodo Anterior)"
    ...
    header_font_color: "#FFFFFF"
    header_text_alignment: left
    fields: [dim_origenventa.canal, fct_ventas_nopdt.venta_periodo, fct_ventas_nopdt.venta_yoy, fct_ventas_nopdt.tickets_periodo, fct_ventas_nopdt.tickets_yoy, fct_ventas_nopdt.unidades_periodo, fct_ventas_nopdt.unidades_yoy]
    filters:
      fct_ventas_nopdt.en_periodo_o_aa: "yes"
    sorts: [fct_ventas_nopdt.venta_periodo desc]
    hidden_fields: [fct_ventas_nopdt.venta_periodo, fct_ventas_nopdt.venta_yoy, fct_ventas_nopdt.tickets_periodo, fct_ventas_nopdt.tickets_yoy, fct_ventas_nopdt.unidades_periodo, fct_ventas_nopdt.unidades_yoy]
  ...
  - title: "Resumen por Tienda (Periodo Seleccionado vs Periodo Anterior)"
    ...
    header_font_color: "#FFFFFF"
    header_text_alignment: left
    fields: [dim_sucursal.sucursal, dim_sucursal.cd_sucursal, fct_ventas_nopdt.venta_periodo, fct_ventas_nopdt.venta_yoy, fct_ventas_nopdt.tickets_periodo, fct_ventas_nopdt.tickets_yoy, fct_ventas_nopdt.unidades_periodo, fct_ventas_nopdt.unidades_yoy]
    filters:
      fct_ventas_nopdt.en_periodo_o_aa: "yes"
    sorts: [fct_ventas_nopdt.venta_periodo desc]
    limit: 50
  ...
  - title: "Tickets por Formato"
    ...
    header_font_color: "#FFFFFF"
    header_text_alignment: left
    fields: [dim_formato.formato, fct_ventas_nopdt.tickets, fct_ventas_nopdt.pct_tickets_total]
    sorts: [fct_ventas_nopdt.tickets desc]
    series_cell_visualizations: { fct_ventas_nopdt.tickets: { is_active: false } }
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 0
    col: 0
    width: 6
  ...
  - title: "Tickets por Canal"
    ...
    fields: [dim_origenventa.canal, fct_ventas_nopdt.tickets]
    pivots: [dim_origenventa.canal]
    sorts: [fct_ventas_nopdt.tickets desc]
    stacking: percent
    show_value_labels: true
    filters:
      fct_ventas_nopdt.tickets: ">=57000"
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 0
    col: 6
    width: 10
  ...
  - title: "Top Marcas - Tickets"
    ...
    header_font_color: "#FFFFFF"
    header_text_alignment: left
    fields: [dim_marca.marca, fct_ventas_nopdt.tickets]
    sorts: [fct_ventas_nopdt.tickets desc]
    limit: 15
    series_cell_visualizations: { fct_ventas_nopdt.tickets: { is_active: false } }
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
  ...
  - title: "Marca Propia vs Resto (unidades)"
    ...
    type: looker_bar
    colors: ["#2E7D32", "#F57C00", "#66BB6A", "#FB8C00", "#1B5E20", "#E65100"]
    fields: [dim_articulo.marca_propia, fct_ventas_nopdt.unidades]
    pivots: [dim_articulo.marca_propia]
    sorts: [fct_ventas_nopdt.unidades desc]
    stacking: percent
    show_value_labels: true
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 5
  ...
  - title: "Participacion por Departamento"
    ...
    type: looker_column
    colors: ["#F57C00"]
    fields: [dim_departamento.departamento, fct_ventas_nopdt.pct_tickets_total]
    sorts: [fct_ventas_nopdt.pct_tickets_total desc]
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 8
    col: 6
    width: 10
  ...
  - title: "Top 10 Categorias - Tickets"
    ...
    type: looker_bar
    colors: ["#F57C00"]
    fields: [dim_categoria.categoria, fct_ventas_nopdt.tickets]
    sorts: [fct_ventas_nopdt.tickets desc]
    limit: 10
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 13
  ...
  - title: "Top Productos - Tickets"
    ...
    header_font_color: "#FFFFFF"
    header_text_alignment: left
    fields: [dim_articulo.producto, fct_ventas_nopdt.tickets]
    sorts: [fct_ventas_nopdt.tickets desc]
    limit: 20
    series_cell_visualizations: { fct_ventas_nopdt.tickets: { is_active: false } }
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
  ...
  - title: "Unidades por Formato"
    ...
    header_font_color: "#FFFFFF"
    header_text_alignment: left
    fields: [dim_formato.formato, fct_ventas_nopdt.unidades, fct_ventas_nopdt.pct_unidades_total]
    sorts: [fct_ventas_nopdt.unidades desc]
    series_cell_visualizations: { fct_ventas_nopdt.unidades: { is_active: false } }
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 0
    col: 0
    width: 6
  ...
  - title: "Unidades por Canal"
    ...
    type: looker_bar
    colors: ["#2E7D32", "#F57C00", "#66BB6A", "#FB8C00", "#1B5E20", "#E65100"]
    fields: [dim_origenventa.canal, fct_ventas_nopdt.unidades]
    pivots: [dim_origenventa.canal]
    sorts: [fct_ventas_nopdt.unidades desc]
    stacking: percent
    show_value_labels: true
    filters:
      fct_ventas_nopdt.unidades: ">=227000"
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 0
    col: 6
    width: 10
  ...
  - title: "Top Marcas - Unidades"
    ...
    header_font_color: "#FFFFFF"
    header_text_alignment: left
    fields: [dim_marca.marca, fct_ventas_nopdt.unidades]
    sorts: [fct_ventas_nopdt.unidades desc]
    limit: 15
    series_cell_visualizations: { fct_ventas_nopdt.unidades: { is_active: false } }
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
  ...
  - title: "Participacion por Departamento"
    ...
    type: looker_column
    colors: ["#FBC02D"]
    fields: [dim_departamento.departamento, fct_ventas_nopdt.pct_unidades_total]
    sorts: [fct_ventas_nopdt.pct_unidades_total desc]
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 8
    col: 6
    width: 10
  ...
  - title: "Top 10 Categorias - Unidades"
    ...
    type: looker_bar
    colors: ["#FBC02D"]
    fields: [dim_categoria.categoria, fct_ventas_nopdt.unidades]
    sorts: [fct_ventas_nopdt.unidades desc]
    limit: 10
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 13
  ...
  - title: "Top Productos - Unidades"
    ...
    header_font_color: "#FFFFFF"
    header_text_alignment: left
    fields: [dim_articulo.producto, fct_ventas_nopdt.unidades]
    sorts: [fct_ventas_nopdt.unidades desc]
    limit: 20
    series_cell_visualizations: { fct_ventas_nopdt.unidades: { is_active: false } }
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
  ...
  - title: "Ventas por Formato"
    ...
    header_font_color: "#FFFFFF"
    header_text_alignment: left
    fields: [dim_formato.formato, fct_ventas_nopdt.venta_neta, fct_ventas_nopdt.pct_venta_total]
    sorts: [fct_ventas_nopdt.venta_neta desc]
    series_cell_visualizations: { fct_ventas_nopdt.venta_neta: { is_active: false } }
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 0
    col: 0
    width: 6
  ...
  - title: "Ventas por Canal"
    ...
    type: looker_bar
    colors: ["#2E7D32", "#F57C00", "#66BB6A", "#FB8C00", "#1B5E20", "#E65100"]
    fields: [dim_origenventa.canal, fct_ventas_nopdt.venta_neta]
    pivots: [dim_origenventa.canal]
    sorts: [fct_ventas_nopdt.venta_neta desc]
    stacking: percent
    show_value_labels: true
    filters:
      fct_ventas_nopdt.venta_neta: ">=1920000000"
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 0
    col: 6
    width: 10
  ...
  - title: "Top Marcas - Venta y Margen $"
    ...
    header_font_color: "#FFFFFF"
    header_text_alignment: left
    fields: [dim_marca.marca, fct_ventas_nopdt.venta_neta, fct_ventas_nopdt.margen_pesos]
    sorts: [fct_ventas_nopdt.venta_neta desc]
    limit: 15
    series_cell_visualizations: { fct_ventas_nopdt.venta_neta: { is_active: false } }
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
  ...
  - title: "Marca Propia vs Resto (venta)"
    ...
    type: looker_bar
    colors: ["#2E7D32", "#F57C00", "#66BB6A", "#FB8C00", "#1B5E20", "#E65100"]
    fields: [dim_articulo.marca_propia, fct_ventas_nopdt.venta_neta]
    pivots: [dim_articulo.marca_propia]
    sorts: [fct_ventas_nopdt.venta_neta desc]
    stacking: percent
    show_value_labels: true
  ...
  - title: "Participacion por Departamento"
    ...
    type: looker_column
    colors: ["#2E7D32"]
    fields: [dim_departamento.departamento, fct_ventas_nopdt.pct_venta_total]
    sorts: [fct_ventas_nopdt.pct_venta_total desc]
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 8
    col: 6
    width: 10
  ...
  - title: "Top 10 Categorias - Venta"
    ...
    type: looker_bar
    colors: ["#2E7D32"]
    fields: [dim_categoria.categoria, fct_ventas_nopdt.venta_neta]
    sorts: [fct_ventas_nopdt.venta_neta desc]
    limit: 10
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 13
  ...
  - title: "Top Productos - Venta"
    ...
    header_font_color: "#FFFFFF"
    header_text_alignment: left
    fields: [dim_articulo.producto, fct_ventas_nopdt.venta_neta]
    sorts: [fct_ventas_nopdt.venta_neta desc]
    limit: 20
    series_cell_visualizations: { fct_ventas_nopdt.venta_neta: { is_active: false } }
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
