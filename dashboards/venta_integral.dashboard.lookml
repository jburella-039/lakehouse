...
- dashboard: venta_integral
  ...
  - name: sucursal
    ...
    model: lakehouse
    explore: fct_ventas
    field: dim_sucursal.dsc_codsucursal
  - name: departamento
    title: "Departamento"
    type: field_filter
    model: lakehouse
  ...
  - title: "Ventas por dia"
    ...
    listen: { fecha: dim_fecha.fecha_date, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 3
    col: 0
    width: 8
    height: 6
  ...
  - title: "Resumen por Formato (Periodo Seleccionado vs Periodo Anterior)"
    ...
    conditional_formatting: [{apply_formatting_to_row: false, cell_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: "#2E7D32", font_style: {bold: false, italic: false, strikethrough: false}}, fields: [ventas_anio_ant, tickets_anio_ant, unidades_anio_ant], id: 231ddea8-5db0-4436-960f-6b311d29e889, row_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: !!null '', font_style: {bold: false, italic: false, strikethrough: false}}, type: greater than, value: 0, apply_to: selectFields, stringValue: ''},
      {apply_formatting_to_row: false, cell_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: "#C62828", font_style: {bold: false, italic: false, strikethrough: false}}, fields: [ventas_anio_ant, tickets_anio_ant, unidades_anio_ant], id: daa10a6a-4d86-4a98-b24f-ec66e29996a6, row_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: !!null '', font_style: {bold: false, italic: false, strikethrough: false}}, type: less than, value: 0, apply_to: selectFields, stringValue: ''}]
    listen: { fecha: fct_ventas.filtro_fecha, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 12
    col: 0
    width: 24
  ...
  - title: "Resumen por Canal (Periodo Seleccionado vs Periodo Anterior)"
    ...
    - table_calculation: cnl_unidades_anio_ant
      ...
      _type_hint: number
    enable_conditional_formatting: true
    conditional_formatting: [{apply_formatting_to_row: false, cell_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: "#2E7D32", font_style: {bold: false, italic: false, strikethrough: false}}, fields: [cnl_ventas_anio_ant, cnl_tickets_anio_ant, cnl_unidades_anio_ant], id: 3edb97b6-abaa-4a39-ba73-78a0f72d57e8, row_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: !!null '', font_style: {bold: false, italic: false, strikethrough: false}}, type: greater than, value: 0, apply_to: selectFields, stringValue: ''},
      {apply_formatting_to_row: false, cell_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: "#C62828", font_style: {bold: false, italic: false, strikethrough: false}}, fields: [cnl_ventas_anio_ant, cnl_tickets_anio_ant, cnl_unidades_anio_ant], id: 98e8aa36-9e72-4052-8694-e2f4cb55ea2c, row_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: !!null '', font_style: {bold: false, italic: false, strikethrough: false}}, type: less than, value: 0, apply_to: selectFields, stringValue: ''}]
    listen: { fecha: fct_ventas.filtro_fecha, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 18
    col: 0
    width: 24
  ...
  - title: "Resumen por Tienda (Periodo Seleccionado vs Periodo Anterior)"
    ...
    - table_calculation: tnd_unidades_anio_ant
      ...
      _type_hint: number
    enable_conditional_formatting: true
    conditional_formatting: [{apply_formatting_to_row: false, cell_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: "#2E7D32", font_style: {bold: false, italic: false, strikethrough: false}}, fields: [tnd_ventas_anio_ant, tnd_tickets_anio_ant, tnd_unidades_anio_ant], id: df17625f-d92d-488b-8d5c-1a6f4ed61a89, row_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: !!null '', font_style: {bold: false, italic: false, strikethrough: false}}, type: greater than, value: 0, apply_to: selectFields, stringValue: ''},
      {apply_formatting_to_row: false, cell_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: "#C62828", font_style: {bold: false, italic: false, strikethrough: false}}, fields: [tnd_ventas_anio_ant, tnd_tickets_anio_ant, tnd_unidades_anio_ant], id: 87d8e3b6-8afa-4de2-b295-d7d0197f1c41, row_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: !!null '', font_style: {bold: false, italic: false, strikethrough: false}}, type: less than, value: 0, apply_to: selectFields, stringValue: ''}]
    listen: { fecha: fct_ventas.filtro_fecha, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, departamento: dim_departamento.departamento, categoria: dim_categoria.categoria, marca: dim_marca.marca, canal: dim_origenventa.canal, marca_propia: dim_articulo.marca_propia }
    row: 24
    col: 0
    width: 24
  ...
  - title: "Resumen por Dispensa"
    ...
    - table_calculation: rdsp_unidades_anio_ant
      ...
      _type_hint: number
    enable_conditional_formatting: true
    conditional_formatting: [{apply_formatting_to_row: false, cell_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: "#2E7D32", font_style: {bold: false, italic: false, strikethrough: false}}, fields: [rdsp_ventas_anio_ant, rdsp_remitos_anio_ant, rdsp_unidades_anio_ant], id: 50c26240-ed17-49e1-a991-681d08669356, row_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: !!null '', font_style: {bold: false, italic: false, strikethrough: false}}, type: greater than, value: 0, apply_to: selectFields, stringValue: ''},
      {apply_formatting_to_row: false, cell_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: "#C62828", font_style: {bold: false, italic: false, strikethrough: false}}, fields: [rdsp_ventas_anio_ant, rdsp_remitos_anio_ant, rdsp_unidades_anio_ant], id: 5df32aea-0d8e-441d-8959-5bf9eed414bc, row_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: !!null '', font_style: {bold: false, italic: false, strikethrough: false}}, type: less than, value: 0, apply_to: selectFields, stringValue: ''}]
    listen: { fecha: fct_remitos.filtro_fecha, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, dispensa: fct_remitos.tipo_dispensa, obrasocial: dim_obrasocial.obrasocial }
    row: 12
    col: 0
    width: 24
  ...
  - title: "Resumen por Tienda (Periodo Seleccionado vs Periodo Anterior)"
    ...
    hidden_fields: [fct_remitos.venta_periodo, fct_remitos.venta_yoy, fct_remitos.remitos_periodo, fct_remitos.remitos_yoy, fct_remitos.unidades_periodo, fct_remitos.unidades_yoy]
    dynamic_fields:
    - table_calculation: rtnd_ventas_cur
      label: "Venta Remitos $"
      expression: "${fct_remitos.venta_periodo}"
      value_format_name: usd_0
      _kind_hint: measure
      _type_hint: number
    - table_calculation: rtnd_ventas_anio_ant
      label: "Venta Año Ant"
      expression: "${fct_remitos.venta_yoy}"
      value_format_name: percent_1
      _kind_hint: measure
    ...
    - table_calculation: rtnd_remitos_cur
      ...
      _kind_hint: measure
      _type_hint: number
    - table_calculation: rtnd_remitos_anio_ant
      label: "Remitos Año Ant"
      expression: "${fct_remitos.remitos_yoy}"
      value_format_name: percent_1
      _kind_hint: measure
    ...
    - table_calculation: rtnd_unidades_cur
      ...
      _kind_hint: measure
      _type_hint: number
    - table_calculation: rtnd_unidades_anio_ant
      label: "Unidades Año Ant"
      expression: "${fct_remitos.unidades_yoy}"
      value_format_name: percent_1
      _kind_hint: measure
      _type_hint: number
    enable_conditional_formatting: true
    conditional_formatting: [{apply_formatting_to_row: false, cell_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: "#2E7D32", font_style: {bold: false, italic: false, strikethrough: false}}, fields: [rtnd_ventas_anio_ant, rtnd_remitos_anio_ant, rtnd_unidades_anio_ant], id: bf3f0c01-0487-4f03-9b3c-1ab62dc362ea, row_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: !!null '', font_style: {bold: false, italic: false, strikethrough: false}}, type: greater than, value: 0, apply_to: selectFields, stringValue: ''},
      {apply_formatting_to_row: false, cell_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: "#C62828", font_style: {bold: false, italic: false, strikethrough: false}}, fields: [rtnd_ventas_anio_ant, rtnd_remitos_anio_ant, rtnd_unidades_anio_ant], id: bb5948d6-df3d-49a1-a53f-9b0d7aab6ef9, row_format: {background_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2, options: {mirror: true, reverse: false, stepped: false}, palette_id: 4a00499b-c0fe-4b15-a304-4083c07ff4c4}, font_color: !!null '', font_style: {bold: false, italic: false, strikethrough: false}}, type: less than, value: 0, apply_to: selectFields, stringValue: ''}]
    listen: { fecha: fct_remitos.filtro_fecha, formato: dim_formato.formato, provincia: dim_provincia.provincia, sucursal: dim_sucursal.dsc_codsucursal, dispensa: fct_remitos.tipo_dispensa, obrasocial: dim_obrasocial.obrasocial }
    row: 21
    col: 0
    width: 24
